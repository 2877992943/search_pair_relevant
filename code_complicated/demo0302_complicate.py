...
if __name__=='__main__':
	...
	df_train = pd.read_csv('../input/train.csv', encoding="ISO-8859-1")[:1] #update here
	df_test = pd.read_csv('../input/test.csv', encoding="ISO-8859-1")[1:2] #update here
	...
	df_all['brand'] = df_all['brand'].map(lambda x:str_stem(x));print df_all['brand'];print df_all['brand']
